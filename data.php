...
$juice = new Drink('JUICE', 35, 'https://s3-ap-northeast-1.amazonaws.com/progate/shared/images/lesson/php/juice.png', 'cold');
$coffee = new Drink('COFFEE', 40, 'https://s3-ap-northeast-1.amazonaws.com/progate/shared/images/lesson/php/coffee.png', 'hot');
$tea = new Drink('TEA',25,'tea.png', 'hot');
$curry = new Food('CURRY', 90, 'https://s3-ap-northeast-1.amazonaws.com/progate/shared/images/lesson/php/curry.png', 3);
$pasta = new Food('PASTA', 120, 'https://s3-ap-northeast-1.amazonaws.com/progate/shared/images/lesson/php/pasta.png', 1);
$samosa = new Food('SAMOSA', 14, 'samosa.png' , 2);


$menus = array($juice, $coffee,$tea,$curry, $pasta,$samosa );
...
$review9 = new Review($samosa->getName(), $user2->getId(), 'amazing taste');
$review10 = new Review($tea->getName(), $user3->getId(), 'refreshing!');
